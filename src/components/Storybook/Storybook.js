      ...
      <article className="p-5 d-flex h-100 flex-row storybook-intro-page">
        ...
        <Col col="6" addclass="pl-5 pb-5 h-100">
          ...
          <div className="d-flex flex-column justify-content-center h-100">
            ...
            <div className="pb-4"><a href={projects[0].project_link}>Repository</a> | <a href={projects[0].project_host}>Visit the site</a></div>
            <p className="pb-4">{projects[0].project_desc}</p>
      ...
      <article className="p-5 d-flex h-100 flex-row storybook-intro-page">
        ...
        <Col col="6" addclass="pl-5 pb-5 h-100">
          ...
          <div className="d-flex flex-column justify-content-center h-100">
            ...
            <div className="pb-4"><a href={projects[1].project_link}>Repository</a> | <a href={projects[1].project_host}>Visit the site</a></div>
            <p className="pb-4">{projects[1].project_desc}</p>
      ...
      <article className="p-5 d-flex h-100 flex-row storybook-intro-page">
        ...
        <Col col="6" addclass="pl-5 pb-5 h-100">
          ...
          <div className="d-flex flex-column justify-content-center h-100">
            ...
            <div className="pb-4"><a href={projects[2].project_link}>Repository</a> | <a href={projects[2].project_host}>Visit the site</a></div>
            <p className="pb-4">{projects[2].project_desc}</p>
      ...
      <article className="p-5 d-flex h-100 flex-row storybook-intro-page">
        ...
        <Col col="6" addclass="pl-5 pb-5 h-100">
          ...
          <div className="d-flex flex-column justify-content-center h-100">
            ...
            <div className="pb-4"><a href={projects[3].project_link}>Repository</a> | <a href={projects[3].project_host}>Visit the site</a></div>
            <p className="pb-4">{projects[3].project_desc}</p>
      ...
      <article className="p-5 d-flex h-100 flex-row storybook-intro-page">
        ...
        <Col col="6" addclass="pl-5 pb-5 h-100">
          ...
          <div className="d-flex flex-column justify-content-center h-100">
            ...
            <div className="pb-4"><a href={projects[4].project_link}>Repository</a> | <a href={projects[4].project_host}>Visit the site</a></div>
            <p className="pb-4">{projects[4].project_desc}</p>
      ...
      <article className="p-5 d-flex h-100 flex-row storybook-intro-page">
        ...
        <Col col="6" addclass="pl-5 pb-5 h-100">
          ...
          <div className="d-flex flex-column justify-content-center h-100">
            ...
            <div className="pb-4"><a href={projects[5].project_link}>Repository</a> | <a href={projects[5].project_host}>Visit the site</a></div>
            <p className="pb-4">{projects[5].project_desc}</p>
      ...
      <article className="p-5 d-flex h-100 flex-row storybook-intro-page">
        ...
        <Col col="6" addclass="pl-5 pb-5 h-100">
          ...
          <div className="d-flex flex-column justify-content-center h-100">
            ...
            <div className="pb-4"><a href={projects[6].project_link}>Repository</a> | <a href={projects[6].project_host}>Visit the site</a></div>
            <p className="pb-4">{projects[6].project_desc}</p>
      ...
      <article className="p-5 d-flex h-100 flex-row storybook-intro-page">
        ...
        <Col col="6" addclass="pl-5 pb-5 h-100">
          ...
          <div className="d-flex flex-column justify-content-center h-100">
            ...
            <div className="pb-4"><a href={projects[7].project_link}>Repository</a> | <a href={projects[7].project_host}>Visit the site</a></div>
            <p className="pb-4">{projects[7].project_desc}</p>
